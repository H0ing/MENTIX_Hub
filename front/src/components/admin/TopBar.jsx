...
export default function TopBar() {
  ...
  useOutsideClick(wrapRef, () => setOpenDD(null));
  ...
  return (
    <>
      <div className="h-16 flex-shrink-0 flex items-center px-7 border-b border-[#ECE9F4] bg-white relative z-30">

        {/* Right side — role badge, mail, profile */}
        <div ref={wrapRef} className="ml-auto flex items-center gap-4">
          ...
          <div className="relative">
            ...
            {openDD === 'mail' && (
              <div className="absolute top-[46px] right-0 w-[360px] bg-white border border-[#ECE9F4] rounded-[14px] shadow-[0_18px_40px_rgba(30,20,60,0.14)] overflow-hidden z-50">
                  ...
                  {sentForms.map(f => (
                    <div key={f.id} className="px-4 py-[13px] border-b border-[#ECE9F4] last:border-b-0">
                      ...
                      <div className="text-[11px] text-[#B7B2C9] mt-[3px]">
                        ...
                        <span
                          onClick={() => openMail(f)}
                          className="text-[#7C3AED] font-semibold cursor-pointer"
                        >
                          View detail
                        </span>
                      </div>
          ...
          <div className="relative">
            ...
            {openDD === 'profile' && (
              <div className="absolute top-[46px] right-0 w-[220px] bg-white border border-[#ECE9F4] rounded-[14px] shadow-[0_18px_40px_rgba(30,20,60,0.14)] overflow-hidden z-50">
                {/* User info row */}
                ...
                <div
                  onClick={() => { setOpenDD(null); showToast('Profile — coming soon'); }}
                  className="flex items-center gap-2.5 px-4 py-3 text-[13px] cursor-pointer hover:bg-[#F7F5FF] transition-colors"
                >
                  <svg className="w-[15px] h-[15px] text-[#8B8B9E]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
